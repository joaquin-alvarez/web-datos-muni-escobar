...
class DatasetSeeder extends Seeder
{
    public function run()
    {
        $datasets = [
            ...
            [
                'title' => 'Paradas Mi Bus',
                'description' => 'Localización geográfica de las paradas del sistema Mi Bus del Partido de Escobar, representadas como entidades puntuales. Mi Bus es la aplicación municipal que permite consultar en tiempo real la llegada de los colectivos.',
                'category' => 'movilidad-y-transito',
                'organization' => 'Municipalidad de Escobar',
                'version' => '1.0',
                'periodicity' => 'Variable (según incorporación o modificación de paradas)',
                'source' => 'Relevamiento propio del Municipio de Escobar – Sistema Mi Bus',
                'license' => 'Open Data Commons Open Database License (ODbL)',
                'created_date' => Carbon::now()->subMonths(6),
                'last_modified' => Carbon::now()->subDays(1),
                'formats' => ['shp'],
                'files' => [
                    [
                        'name' => 'paradas_mi_bus.shp',
                        'path' => 'datasets/paradas-mi-bus/paradas_mi_bus.shp',
                        'size' => 492,
                    ],
                    [
                        'name' => 'paradas_mi_bus.shx',
                        'path' => 'datasets/paradas-mi-bus/paradas_mi_bus.shx',
                        'size' => 212,
                    ],
                    [
                        'name' => 'paradas_mi_bus.dbf',
                        'path' => 'datasets/paradas-mi-bus/paradas_mi_bus.dbf',
                        'size' => 7960,
                    ],
                    [
                        'name' => 'paradas_mi_bus.prj',
                        'path' => 'datasets/paradas-mi-bus/paradas_mi_bus.prj',
                        'size' => 145,
                    ],
                ],
            ],
            [
                'title' => 'Paradas Seguras del Partido de Escobar',
                'description' => 'Localización geográfica de las Paradas Seguras del Partido de Escobar, representadas como entidades puntuales. Las Paradas Seguras son refugios de transporte público equipados con tecnología de vigilancia y asistencia, que incluyen cámaras 360°, botón de pánico, intercomunicador conectado al centro de monitoreo municipal e iluminación LED.',
                'category' => 'movilidad-y-transito',
                'organization' => 'Municipalidad de Escobar',
                'version' => '1.0',
                'periodicity' => 'Variable (según instalación o reubicación de dispositivos)',
                'source' => 'Relevamiento propio del Municipio de Escobar',
                'license' => 'Open Data Commons Open Database License (ODbL)',
                'created_date' => Carbon::now()->subMonths(6),
                'last_modified' => Carbon::now()->subDays(1),
                ...
                'files' => [
                    [
                        'name' => 'paradas_seguras.shp',
                        'path' => 'datasets/paradas-seguras-del-partido-de-escobar/paradas_seguras.shp',
                        'size' => 1584,
                    ],
                    [
                        'name' => 'paradas_seguras.shx',
                        'path' => 'datasets/paradas-seguras-del-partido-de-escobar/paradas_seguras.shx',
                        'size' => 524,
                    ],
                    [
                        'name' => 'paradas_seguras.dbf',
                        'path' => 'datasets/paradas-seguras-del-partido-de-escobar/paradas_seguras.dbf',
                        'size' => 29683,
                    ],
                    [
                        'name' => 'paradas_seguras.prj',
                        'path' => 'datasets/paradas-seguras-del-partido-de-escobar/paradas_seguras.prj',
                        'size' => 145,
                    ],
                ],
            ],
            [
                'title' => 'Registro Abierto de Políticas de Género, Niñez y Asistencia Crítica',
                'description' => 'Registro abierto de políticas municipales vinculadas a género, niñez y asistencia crítica del Partido de Escobar, correspondiente al ciclo 2025. Contiene información sobre programas, dispositivos territoriales y acciones institucionales en materia de derechos humanos, protección y acompañamiento social.',
                ...
                'files' => [
                    [
                        'name' => 'Registro Abierto de Políticas de Género, Niñez y Asistencia Crítica - Ciclo 2025.pdf',
                        'path' => 'datasets/registro-abierto-de-politicas-de-genero-ninez-y-asistencia-critica/Registro Abierto de Políticas de Género, Niñez y Asistencia Crítica - Ciclo 2025.pdf',
                        'size' => 270000,
                    ],
                ],
            ],
